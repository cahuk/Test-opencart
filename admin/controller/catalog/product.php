...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		// array of product type
        $data['arr_types'] = array("product", "service");
        //
        ...
        if (isset($this->request->post['product_form'])) {
            $data['product_form'] = $this->request->post['product_form'];
        } elseif (isset($this->request->get['product_id'])) {
            $data['product_form'] = $this->model_catalog_product->getProductDescriptions($this->request->get['product_id']);
        } else {
            $data['product_form'] = array();
        }
        //
